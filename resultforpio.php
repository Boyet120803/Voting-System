...
<div class="d-flex" id="wrapper">
    ...
    <?php
    $data = $user->pio();
    $highestpio = !empty($data['highest']) ? $data['highest']['pio'] : "No data found for president with highest count.";
    $highestCount = !empty($data['highest']) ? $data['highest']['count'] : "";
    $lowestpio = !empty($data['lowest']) ? $data['lowest']['pio'] : "No data found for president with lowest count.";
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>Highest</td>
                <td><?php echo $highestpio; ?></td>
                <td><?php echo $highestCount; ?></td>
            </tr>
            <tr>
                <td>Lowest</td>
                <td><?php echo $lowestpio; ?></td>

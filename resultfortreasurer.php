...
<div class="d-flex" id="wrapper">
    ...
    <?php
    $data = $user->treasurer();
    $highesttreasurer = !empty($data['highest']) ? $data['highest']['treasurer'] : "No data found for president with highest count.";
    $highestCount = !empty($data['highest']) ? $data['highest']['count'] : "";
    $lowesttreasurer = !empty($data['lowest']) ? $data['lowest']['treasurer'] : "No data found for president with lowest count.";
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>Highest</td>
                <td><?php echo $highesttreasurer; ?></td>
                <td><?php echo $highestCount; ?></td>
            </tr>
            <tr>
                <td>Lowest</td>
                <td><?php echo $lowesttreasurer; ?></td>

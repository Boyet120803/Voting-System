...
<div class="d-flex" id="wrapper">
    ...
    <?php
    $data = $user->vicepresident();
    $highestvicePresident = !empty($data['highest']) ? $data['highest']['vice_president'] : "No data found for president with highest count.";
    $highestCount = !empty($data['highest']) ? $data['highest']['count'] : "";
    $lowestvicePresident = !empty($data['lowest']) ? $data['lowest']['vice_president'] : "No data found for president with lowest count.";
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>Highest</td>
                <td><?php echo $highestvicePresident; ?></td>
                <td><?php echo $highestCount; ?></td>
            </tr>
            <tr>
                <td>Lowest</td>
                <td><?php echo $lowestvicePresident; ?></td>

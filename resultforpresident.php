...
<div class="d-flex" id="wrapper">
    ...
    <?php
    $data = $user->president();
    $highestPresident = !empty($data['highest']) ? $data['highest']['president'] : "No data found for president with highest count.";
    $highestCount = !empty($data['highest']) ? $data['highest']['count'] : "";
    $lowestPresident = !empty($data['lowest']) ? $data['lowest']['president'] : "No data found for president with lowest count.";
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>Highest</td>
                <td><?php echo $highestPresident; ?></td>
                <td><?php echo $highestCount; ?></td>
            </tr>
            <tr>
                <td>Lowest</td>
                <td><?php echo $lowestPresident; ?></td>

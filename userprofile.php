...
<div class="d-flex" id="wrapper">
            <div class="border-end bg-white col-2" id="sidebar-wrapper">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active <?php echo($role == 0 ? 'd-lock' : 'd-none') ?>" href="#">User Profile</a> 
                <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php echo($role == 0 ? 'd-lock' : 'd-none') ?>" href="voter-form.php">Vote now</a>             
        ...
        <center><h2>User Profile</h2></center>
            ...
            <?php 
                    ...
                    $data = $user->fetchDatasignup($_SESSION['ID']);
                ...
                <a href="userform-edit.php?id=<?php echo $row['id'];?>" class="btn btn-secondary" type="button">Edit Profile</a>
            </form>
    </main>
</div>
            </div>   

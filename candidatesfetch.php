...
<div class="d-flex" id="wrapper">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th scope="col">Name of Your PartyList</th>  
                        <th scope="col"> <a href="resultforpresident.php">President</a></th>
                        <th scope="col"><a href="resultforvicepresident.php">Vice President</a></th>       
                        <th scope="col"><a href="resultforsecretary.php">Secretary</a></th>   
                        <th scope="col"><a href="resultfortreasurer.php">Treasurer</a></th>
                        <th scope="col"><a href="resultforpio.php">Pio </a></th>      
                ...
                <tbody>
                    ...
                    foreach ($data as $row): ?>
                        <tr>
                            <td> <?php echo $row['n_partylist']; ?></td>
                            ...
                            <td><a  href="crud.php?deletecandidatessuccesfully=<?php echo $row['id'] ?>">
            ...
            <div class="add">
              <a href="candidates-form.php">Add Candidates</a>
            </div>
